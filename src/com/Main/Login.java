...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        check_pw.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/hide.png"))); // NOI18N
        check_pw.setOpaque(false);
        check_pw.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                check_pwActionPerformed(evt);
            }
        });
        jPanel1.add(check_pw, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 370, 35, 30));
    ...
    private void check_pwActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_check_pwActionPerformed
        if (check_pw.isSelected()){
            check_pw.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/unhide.png")));
            txt_pass.setEchoChar((char)0);

        } else {
            check_pw.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/hide.png")));
