...
public class popup_login extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btn_tambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/ok.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popup_login dialog = new popup_login(new javax.swing.JFrame(), true);
